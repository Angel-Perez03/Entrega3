...
public class FacturaImpresora {
    ...
    public void generarFacturaPDF(String nombreCliente, String carCategory, String deliveryLocation) {
        ...
        try {
            ...
            formateadora.formatoBasico(document, nombreCliente, carCategory, 0, rutaImagen);
