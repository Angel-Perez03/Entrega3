...
public class ChangeCarStatusWindow extends JDialog{
	/**
	 * 
	 */
	...
	public ChangeCarStatusWindow(Frame owner) {
        super(owner, "Change Car Status", true);
        this.owner = owner;
	...
	private void buildTitleContainer() {
		...
		titleLabel = new JLabel("Change Car Status");
	...
	private void buildConfigPanel() {
		...
		configPanel.add(new ChangeCarStatusWindowQuestions(owner, this));
