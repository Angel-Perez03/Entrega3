...
public class NewCreditCardWindow extends JDialog {
	/**
	 * 
	 */
	...
	public NewCreditCardWindow(Frame owner) {
        super(owner, "New Driver License", true);
        this.owner = owner;
	...
	private void buildTitleContainer() {
		...
		titleLabel = new JLabel("New Credit Card");
	...
	private void buildConfigPanel() {
		...
		configPanel.add(new NewCreditCardWindowQuestions(owner, this));
